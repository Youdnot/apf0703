...
from grounding_sam2.sam2.build_sam import build_sam2, build_sam2_video_predictor
from grounding_sam2.sam2.sam2_image_predictor import SAM2ImagePredictor
from transformers import AutoModelForZeroShotObjectDetection, AutoProcessor
from grounding_sam2.utils.common_utils import CommonUtils
from grounding_sam2.utils.mask_dictionary_model import MaskDictionaryModel, ObjectInfo
from grounding_sam2.utils.track_utils import sample_points_from_masks
from grounding_sam2.utils.video_utils import create_video_from_images
...
class SAM2ImageSegmentor:
    ...
    def __init__(self, sam_model_cfg: str, sam_model_ckpt: str, device="cuda"):
        ...
        """
        from grounding_sam2.sam2.build_sam import build_sam2
        from grounding_sam2.sam2.sam2_image_predictor import SAM2ImagePredictor
