...
obstacle_mask = np.load("assets/mask_00000.npy", allow_pickle=True)
# Transpose and flip to match the coordinate system
obstacle_mask = np.flip(obstacle_mask.T, axis=(1))
